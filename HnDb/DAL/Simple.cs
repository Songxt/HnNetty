...
//        private const string Encapsulation2 = "public.{0} ";
//        private const string GetIdentitySql = "SELECT LASTVAL() AS id";

//        private const string GetPagedListSql = "Select {SelectColumns} from {TableName} {WhereClause} " +
//                                               "Order By {OrderBy} LIMIT {RowsPerPage} OFFSET (({PageNumber}-1) * {RowsPerPage})"
//            ;
...
//            string tablename = null, IDbTransaction transaction = null, int? commandTimeout = null)
//        {
//            return Insert<int?, TEntity>(connection, entityToInsert, tablename, transaction, commandTimeout);
//        }
...
//            var name = tablename ?? GetTableName(entityToInsert);
//            var sb = new StringBuilder();
...
//            TEntity sourceEntity, object whereConditions = null)
//        {
...
//                if (property.GetCustomAttributes(true)
//                    .Any(attr => attr.GetType().Name == typeof(ReadOnlyAttribute).Name &&
//                                 IsReadOnly(property))) continue;
...
//            updateableProperties =
//                updateableProperties.Where(p => p.GetCustomAttributes(true)
...
//                                                                 typeof(IgnoreUpdateAttribute).Name) == false);
//            //remove ones that are not mapped
//            updateableProperties =
//                updateableProperties.Where(p => p.GetCustomAttributes(true)
//                                                    .Any(attr => attr.GetType().Name ==
//                                                                 typeof(NotMappedAttribute).Name) == false);
...
//        {
//            var tp = type.GetProperties().Where(p => p.GetCustomAttributes(true)
...
//        private static string TableFormat(string databaseword)
//        {
//            return string.Format(Encapsulation2, databaseword);
//        }
